pipeline{
    ...
    stages{
        ...
        stage('Docker Deploy'){
            steps{
              ansiblePlaybook credentialsId: 'mb777', disableHostKeyChecking: true, extras: "-e DOCKER_TAG=${DOCKER_TAG}", installation: 'ansible', inventory: 'dev.inv', playbook: 'deploy_docker_1.yml'
            }
        }
    }
}
